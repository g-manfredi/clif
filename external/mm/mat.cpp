...
static bool h5_obj_exists(H5::H5File f, const char * const path)
{  
  H5E_auto2_t  oldfunc;
...
static bool h5_obj_exists(H5::H5File f, const std::string path)
{
  return h5_obj_exists(f,path.c_str());
}

static bool h5_obj_exists(H5::H5File f, const boost::filesystem::path path)
{
